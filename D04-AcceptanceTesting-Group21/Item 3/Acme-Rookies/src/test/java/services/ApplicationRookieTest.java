...
@Transactional
public class ApplicationRookieTest extends AbstractTest {
	...
	public void driverManage() {
		...
		final Object testingData[][] = {
				 ...
				 * application siendo rookie1.
				 */
				{ 1, 0, positionIdFinal, "rookie1", null },
				/*
				 * a) Functional requirements - 10.1. An actor who is
				 * authenticated as a rookie must be able to manage his or her
				 ...
				 * application siendo rookie1.
				 */
				{ 0, applicationId, 0, "rookie1", null },
				/*
				 * a) Functional requirements - 10.1. An actor who is
				 * authenticated as a rookie must be able to manage his or her
				 * applications - Create b) Negative test - Business rule: It
				 * can created if you are not a rookie. c) analysis of sentence
				 ...
				 * created if you are not a rookie. c) analysis of sentence
				 * coverage: 95.8% d) analysis of data coverage - se edita
				 ...
				 * authenticated as a rookie must be able to manage his or her
				 * applications - Edit b) Negative test - Business rule: It can
				 * be edited if it's not from the rookie. c) analysis of
				 * sentence coverage: 95.8% d) analysis of data coverage - se edita
				 * application ajena.
				 */
				{ 0, applicationId, 0, "rookie2",
						java.lang.IllegalArgumentException.class },
				/*
				 * a) Functional requirements - 10.1. An actor who is
				 * authenticated as a rookie must be able to manage his or her
