...
@Transactional
public class EducationDataRookieTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
			 ...
			 * - se crea educationData siendo rookie1.
			 */
			{
				degree, curriculaIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is
			 * authenticated as a company must be able to manage their
			 ...
			 * analysis of sentence coverage: 92.4% d) analysis of data coverage
			 * - se intenta crear educationData siendo rookie1 a una
			 * curricula ajena.
			 */
			{
				degree, curriculaIdNotMine, "rookie", java.lang.IllegalArgumentException.class
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is
			 * authenticated as a company must be able to manage their
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
			 ...
			 * analysis of sentence coverage: 92.4% d) analysis of data coverage
			 * - se edita educationData siendo rookie1.
			 */
			{
				degree, educationDataIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is
			 * authenticated as a company must be able to manage their
			 ...
			 * analysis of sentence coverage: 92.4% d) analysis of data coverage
			 * - se intenta editar educationData ajeno siendo rookie1.
			 */
			{
				degree, educationDataIdNotMine, "rookie1", java.lang.IllegalArgumentException.class
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is
			 * authenticated as a company must be able to manage their
			 ...
			 */
			{
				null, educationDataIdMine, "rookie1", javax.validation.ConstraintViolationException.class
			}
		};
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
			 ...
			 * - se elimina educationData siendo rookie1.
			 */
			{
				educationDataIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is
			 * authenticated as a company must be able to manage their
			 ...
			 * analysis of sentence coverage: 89.7% d) analysis of data coverage
			 * - se intenta eliminar educationData ajeno siendo rookie1.
			 */
			{
				educationDataIdNotMine, "rookie1", java.lang.IllegalArgumentException.class
			}
