...
@Transactional
public class FinderRookieTest extends AbstractTest {
	...
	public void driverFinder() {
		...
		final Object testingData[][] = {
			 ...
			 * keyword="" The actor in charge is: rookie2
			 */

			{
				"rookie2", "finder1", "", false, null
			},
			/*
			 * a) Functional requirements - member must be able to manage
			 ...
			 */
			{
				"rookie1", "finder1", "", false, IllegalArgumentException.class
			}
		};
