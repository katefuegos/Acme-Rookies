...
@Transactional
public class PositionDataRookieTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		final Object testingData[][] = {
			 ...
			 * - se crea positionData siendo rookie1.
			 */
			{
				title, curriculaIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is authenticated as a company must
			 ...
			 * analysis of sentence coverage: 92.4 % d) analysis of data coverage
			 * - se intenta crear positionData siendo rookie1 a una curricula ajena.
			 */
			{
				title, curriculaIdNotMine, "rookie1", java.lang.IllegalArgumentException.class
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is authenticated as a company must
			 * be able to manage their database of positionDatas. - Create. b) Negative test -
			 ...
			 * analysis of sentence coverage: 92.4 % d) analysis of data coverage
			 * - se intenta crear positionData siendo rookie1 sin atributo title.
			 */
			{
	...
	public void driverEdit() {
		...
		final Object testingData[][] = {
			 ...
			 * - se edita positionData siendo rookie1.
			 */
			{
				title, positionDataIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is authenticated as a company must
			 ...
			 * analysis of sentence coverage: 89.7% d) analysis of data coverage
			 * - se intenta editar positionData ajeno siendo rookie1.
			 */
			{
				title, positionDataIdNotMine, "rookie1", java.lang.IllegalArgumentException.class
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is authenticated as a company must
			 * be able to manage their database of positionDatas. - Edit. b) Negative test -
			 ...
			 * analysis of sentence coverage: 89.7% d) analysis of data coverage
			 * - se intenta editar positionData siendo rookie1 sin atributo title.
			 */
			{
				null, positionDataIdMine, "rookie1", javax.validation.ConstraintViolationException.class
			}
		};
	...
	public void driverDelete() {
		...
		final Object testingData[][] = {
			 ...
			 * analysis of sentence coverage: 92.4% d) analysis of data coverage
			 * - se elimina positionData siendo rookie1.
			 */
			{
				positionDataIdMine, "rookie1", null
			},
			/*
			 * a) Functional requirements - 9.2. An actor who is authenticated as a company must
			 ...
			 * analysis of sentence coverage: 92.4% d) analysis of data coverage
			 * - se intenta eliminar positionData ajeno siendo rookie1.
			 */
			{
				positionDataIdNotMine, "rookie1", java.lang.IllegalArgumentException.class
			}
